...
pub fn fetch_all_vault_operator_delegation(
  ...
  addresses: &[solana_program::pubkey::Pubkey],
    ...
    let mut decoded_accounts: Vec<crate::shared::DecodedAccount<VaultOperatorDelegation>> = Vec::new();
...
pub fn fetch_all_maybe_vault_operator_delegation(
  ...
  addresses: &[solana_program::pubkey::Pubkey],
    ...
    let accounts = rpc.get_multiple_accounts(addresses)
      .map_err(|e| std::io::Error::new(std::io::ErrorKind::Other, e.to_string()))?;
    let mut decoded_accounts: Vec<crate::shared::MaybeAccount<VaultOperatorDelegation>> = Vec::new();
    for i in 0..addresses.len() {
      let address = addresses[i];
