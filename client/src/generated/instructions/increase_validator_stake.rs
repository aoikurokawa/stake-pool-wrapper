...
impl IncreaseValidatorStake {
  pub fn instruction(&self, args: IncreaseValidatorStakeInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: IncreaseValidatorStakeInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
///
          ...
          ///   6. `[]` validator_stake_account
          ///   7. `[]` validator_vote_account
          ///   8. `[]` clock
          ///   9. `[]` rent
          ///   10. `[]` stake_history
          ///   11. `[]` stake_config
