...
impl InitializeBuilder {
  pub fn new() -> Self {
    ...
    pub fn pool_mint(&mut self, pool_mint: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn manager_pool_account(&mut self, manager_pool_account: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = Initialize {
                              stake_pool: self.stake_pool.expect("stake_pool is not set"),
                                        ...
                                        manager_pool_account: self.manager_pool_account.expect("manager_pool_account is not set"),
          ...
          let args = InitializeInstructionArgs {
                                                              fee: self.fee.clone().expect("fee is not set"),
                                                                  ...
                                                                  max_validators: self.max_validators.clone().expect("max_validators is not set"),
                                    };
...
impl<'a, 'b> InitializeCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn pool_mint(&mut self, pool_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn manager_pool_account(&mut self, manager_pool_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = InitializeInstructionArgs {
                                                              fee: self.instruction.fee.clone().expect("fee is not set"),
                                                                  ...
                                                                  referral_fee: self.instruction.referral_fee.clone().expect("referral_fee is not set"),
                                                                  max_validators: self.instruction.max_validators.clone().expect("max_validators is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          manager_pool_account: self.instruction.manager_pool_account.expect("manager_pool_account is not set"),
