...
use crate::generated::types::PreferredValidatorType;
...
impl SetPreferredValidator {
  pub fn instruction(&self, args: SetPreferredValidatorInstructionArgs) -> solana_program::instruction::Instruction {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = SetPreferredValidatorInstructionArgs {
                                                              validator_type: self.instruction.validator_type.clone().expect("validator_type is not set"),
